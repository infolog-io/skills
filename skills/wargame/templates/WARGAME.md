...
Facts only, each with its source. No recommendations here; routes belong in Moves.

- {{fact}} — {{source path or command}}
...
No judgment calls left to the executor. Every branch has an observable trigger.
