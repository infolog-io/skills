# Estimatrix — worked examples

Eight canonical scenarios. Load this file when the main SKILL.md points here.
...
Two rows, not one rolled-up size. The user can ship the button without the cleanup.
...
Mechanical, well-understood. If call-site count is 500+, bumps to L without changing complexity.
